        ...
        <div class="card-body">
            <form method="POST" action="add">
                ...
                <div class="mb-3">
                    ...
                    <input name="email" class="form-control" id="email" value= "{{old('email')}}" autocomplete="off">
                    @error('email')
                        <p style="color:red">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="varchar" name="contact" class="form-control" id="contact" value= "{{old('contact')}}" autocomplete="off">
                    @error('contact')
                        <p style="color:red">{{ $message }}</p>
                    @enderror
                </div>
