        ...
        <div class="card-body">
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    ...
                    <input type="name" name="name" class="form-control" id="name" value= "{{ old('name',$editid->name) }}">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input name="email" class="form-control" id="email" value= "{{ old('email',$editid->email) }}">
                    @error('email')
                        <p style="color:red">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="varchar" name="contact" class="form-control" id="contact" value= "{{ old('contact',$editid->contact) }}">
                    @error('contact')
                        <p style="color:red">{{ $message }}</p>
                    @enderror
                </div>
